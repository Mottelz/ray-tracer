...
struct Ray {
    glm::dvec3 org; /**< @brief The origin of the ray. #org. */
    glm::dvec3 dir; /**< @brief The direction of the ray. Make sure to normalize!!! #dir. */
};
 ...
 **/
struct Intersect {
    glm::dvec3 pos; /**< @brief The point of the intersection. #pos. */
