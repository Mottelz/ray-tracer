...
void draw(cimg_library::CImg<float> &image, int w, int h, glm::vec3 color); /**< Colours in the given pixel. Given vec3 should be clipped between [0,1] the function converts it.*/
